...
class KerasMeta(type(ABC), type(Part)):
    pass


class KerasPilot(ABC, Part, metaclass=KerasMeta):
    """
    ...
    def __init__(self,
        ...
        Part.__init__(self, interpreter=interpreter,
    ...
    def create(cls, cfg, model=None, model_type='linear'):
        ...
        indicate the model is of type 'tflite_linear' or 'tflite_categorical'
        or similar.
        ...
        :param str model:       Optional path to existing (trained) model. Will
                                ...
                                path, if it is omitted, a new model will be
                                created.
