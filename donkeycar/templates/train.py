...
def train(cfg, tub_names, model_name, transfer_model,
    ...
    if cfg.OPTIMIZER:
        kl.set_optimizer(cfg.OPTIMIZER,
                         cfg.LEARNING_RATE,
...
def go_train(kl, cfg, train_gen, val_gen, gen_records, model_name,
    ...
    if cfg.PRUNE_CNN:
        ...
        target_channels = int(cnn_channels *
                              (1.0 - (float(cfg.PRUNE_PERCENT_TARGET) / 100.0)))

        print('Target channels of {0} remaining with {1:.00%} percent removal '
